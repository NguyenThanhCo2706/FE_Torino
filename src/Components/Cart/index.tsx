              ...
              <div className="flex shadow-md">
                <div className="w-3/4 bg-white px-10 py-10">
                  <div className="flex justify-between border-b pb-8">
                    ...
                    <h2 className="font-semibold text-2xl">{data.orderDetails.length} Sản phẩm</h2>
                  </div>
                  ...
                  {
                    data.orderDetails.map((detail: any, index: number) => {
                      return (
                ...
                <div id="summary" className="w-1/4 px-8 py-10">
                  ...
                  <div className="py-10">
                    ...
                    <input type="date" id="promo" placeholder="Enter your code" className="p-2 text-sm w-full" />
                  </div>
                  <div className="border-t mt-8">
                    ...
                    <button className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Đặt Đơn</button>
                  </div>
                </div>
              </div>
            </div>
